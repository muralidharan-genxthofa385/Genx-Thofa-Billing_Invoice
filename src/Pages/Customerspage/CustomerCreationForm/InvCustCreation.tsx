...
<div className="inv-new-cust-save-btns">
  <button type="submit">Save</button>
  <button onClick={renderNewcustPop}>Cancel</button>
</div>
...
<div className="cancel-button-action-buttons"><button onClick={renderCancelButton}>Stay Here</button><button onClick={()=>{  renderNewcustPop()}} >Leave & Discard Changes</button></div>
  </div>
</div>}
...
export default InvCustCreation